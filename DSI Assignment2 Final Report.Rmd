...
#Training Accuracy
model %>% evalueate(x_train, y_train)
...
(test_accuracy_transferlearn = model %>% evaluate(x_val, y_val))
(train_accuracy_transferlearn = model %>% evaluate(x_train, y_train))
...
# sam / merve?? I have actually done my predictions within chunks, so we can remove this part. Votes?
