...
```
![Figure: Optimisation Metrics](WordCloud.png)
...
```
![Figure: Bag of words model - smaller model - neural net training](images/test_accuracy_wordcount_smaller.png)
...
```
![Figure: TF-IDF model - neural net training](images/test_accuracy_tfidf.png)
...
![Figure: Sentiment Analysis - neural net training](images/test_accuracy_sentiment.png)
...
![Figure: Topic Modelling - neural net training](images/test_accuracy_topic.png)
...
![Figure: CNN - neural net training](images/final_cnn_training_plot.png)
...
![Figure: Glove transfer learning - neural net training](images/test_accuracy_transferlearning.png)
