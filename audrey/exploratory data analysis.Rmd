...
On average, Mandeka, Mbeki and Zuma, the 3 longest reigning presidents, used a similar number of sentences per SONA speech at between 300 and 313. De Klerk used the least number of sentences at 103 and Motlanthe the most at 346, nearly 3.5 times as many as De Klerk.
...
sentence_count %>%
  ...
  geom_vline(xintercept = 1994, color = "grey") +
  geom_vline(xintercept = 1999, color = "grey") +
  geom_vline(xintercept = 2004, color = "grey") +
...
wordcloud2(word_count[1:300, ], size = .5, color='random-dark')
...
wordcloud2(bigram_count[1:300, ], size = .35, color='random-dark')
...
The number of unique words per SONA ranges from about 780 with de Klerk in 1994 to over 2500 with Mandela in his post election speech of 1999. Mbeki's post election speech of 2004 and Zuma's post election speech of 2014 got to about 2250.  
