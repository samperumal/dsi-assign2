...
```
**Insights:** 
Of the 3 presidents that have made more than 1 SONA speech, Zuma has the highest sentiment score, followed by Mbeki and then Mandela. Zuma's sentiment score is nearly double Mandela's. It's interesting that the current President has the second highest sentiment score, not far behind Zuma and only slightly ahead of Mbeki.
...
```
**Insights:** 
Common words across post 1994 presidents include: "freedom", "improve", "support" and "progress". Words introduced by Mandela and unique to his speeches are: "restructuring", "reconciliation" and "contribution". Mbeki introduces the word "integrated" into the top words used and this is unique to his speeches. Zuma uses the words "reform", "pleased", "led" and "sustainable" frequently and other presidents do not. Ramaphosa introduces the words "trust", "recovery", "outstanding", "liberation", "enhance", "efficient", "effective" and "decisive", which have not yet been seen in the any other SA president's top 10 most frequently used words in a SONA since 1994.
